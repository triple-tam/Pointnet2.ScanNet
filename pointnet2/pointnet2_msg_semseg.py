...
RADIUS = [[0.05, 0.1], [0.1, 0.2], [0.2, 0.4], [0.4, 0.8]] # local region grows w each SA layer; fewer N' local pts, but larger local region
...
class Pointnet2MSG(nn.Module):
    ...
    def forward(self, pointcloud: torch.cuda.FloatTensor):
        ...
        for i in range(-1, -(len(self.FP_modules) + 1), -1): # going from -1 to -5
